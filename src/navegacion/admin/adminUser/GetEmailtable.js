            ...
            <Table responsive id="tableusers" striped bordered hover>
              ...
              <tbody>
                  <tr >
                    ...
                    <td className="td">{usuario.cell}</td>
                    <td className="td">{usuario.dateBirth}</td>
                    <td className="td">{usuario.apartmentNumber}</td>
